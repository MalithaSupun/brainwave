...
const Services = () => {
  return (
    ...
    <div className="container">
        <Heading className="md:text-center" title="Genarative AI made for creators."
            text="Brainwave unlocks the potentioal of AI-powerd applications"
        />
        ...
        <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <p className="body-2 mb-[3rem] text-n-3">Brainwave unlocks the potentioal of AI-powerd applications</p>
            <ul className="body-2">
